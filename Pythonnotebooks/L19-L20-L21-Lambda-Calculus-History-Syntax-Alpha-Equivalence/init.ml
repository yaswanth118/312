#require "str";;
#directory "/cs3100-2021/lectures/lambda";;
#load_rec "/cs3100-2021/lectures/lambda/syntax.cmo";;
#load_rec "/cs3100-2021/lectures/lambda/lambda_parse.cmo";;
#load_rec "/cs3100-2021/lectures/lambda/eval.cmo";;
